...
(facts "Render template with query results"
       (fact "Render ftl with one query result"
             (parse-string (rt/render-template ftl-config query-results template-map1) true)
             =>
             (parse-string "{\"dataSet\":\"Rendered Dataset\",
                   \"orgUnit\":\"71345684\",
                   \"period\":\"20141111\",
                   \"dataValues\":[{\"dataElement\":\"AiPqHCbJQJ1\",\"categoryOptionCombo\":\"u2QXNMacZLt\",\"value\":\"Rendered v1\"},{\"dataElement\":\"AiPqHCbJQJ1\",\"categoryOptionCombo\":\"UBdaznQ8DlT\",\"value\":\"Rendered v3\"},{\"dataElement\":\"AiPqHCbJQJ2\",\"categoryOptionCombo\":\"KahybAysMCQ\",\"value\":\"Rendered v6\"}]}" true))
       (fact "Render ftl with multiple query results"
             (set= (get (parse-string (rt/render-template ftl-config query-results template-map2) true) "dataValues")
                   (get (parse-string "{\"dataSet\":\"Rendered Dataset\",\n\"orgUnit\":\"71345684\",\n\"period\":\"20141111\",\n\"dataValues\":[{\"dataElement\":\"AiPqHCbJQJ1\",\"categoryOptionCombo\":\"u2QXNMacZLt\",\"value\":\"Rendered v1\"},{\"dataElement\":\"AiPqHCbJQJ1\",\"categoryOptionCombo\":\"DA2N93v7s0O\",\"value\":\"Rendered v2\"},{\"dataElement\":\"AiPqHCbJQJ1\",\"categoryOptionCombo\":\"UBdaznQ8DlT\",\"value\":\"Rendered v3\"},{\"dataElement\":\"AiPqHCbJQJ2\",\"categoryOptionCombo\":\"tSwmrlTW11V\",\"value\":\"Rendered v4\"},{\"dataElement\":\"AiPqHCbJQJ2\",\"categoryOptionCombo\":\"GYRYyntlK7n\",\"value\":\"Rendered v5\"},{\"dataElement\":\"AiPqHCbJQJ2\",\"categoryOptionCombo\":\"KahybAysMCQ\",\"value\":\"Rendered v6\"}]}" true) "dataValues"))
             =>
             true))

(facts "Render template with query results"
       (fact "Render ftl with multiple template maps"
             (let [expected (parse-string "[{\n    \"dataSet\": \"Rendered Dataset\",\n    \"period\": \"20141111\",\n    \"orgUnit\": \"71345684\",\n    \"dataValues\": [\n    {\n    \"dataElement\": \"AiPqHCbJQJ1\",\n    \"categoryOptionCombo\": \"u2QXNMacZLt\",\n    \"value\": \"Rendered v1\"\n    },\n    {\n    \"dataElement\": \"AiPqHCbJQJ1\",\n    \"categoryOptionCombo\": \"UBdaznQ8DlT\",\n    \"value\": \"Rendered v3\"\n    },\n    {\n    \"dataElement\": \"AiPqHCbJQJ2\",\n    \"categoryOptionCombo\": \"KahybAysMCQ\",\n    \"value\": \"Rendered v6\"\n    }\n]\n}, {\n  \"dataSet\": \"Rendered Dataset\",\n  \"period\": \"20141111\",\n  \"orgUnit\": \"71345684\",\n  \"dataValues\": [\n    {\n      \"dataElement\": \"AiPqHCbJQJ1\",\n      \"categoryOptionCombo\": \"u2QXNMacZLt\",\n      \"value\": \"Rendered v1\"\n    },\n    {\n      \"dataElement\": \"AiPqHCbJQJ1\",\n      \"categoryOptionCombo\": \"UBdaznQ8DlT\",\n      \"value\": \"Rendered v3\"\n    },\n    {\n      \"dataElement\": \"AiPqHCbJQJ2\",\n      \"categoryOptionCombo\": \"KahybAysMCQ\",\n      \"value\": \"Rendered v6\"\n    },\n    {\n    \"dataElement\": \"AiPqHCbJQJ1\",\n    \"categoryOptionCombo\": \"DA2N93v7s0O\",\n    \"value\": \"Rendered v2\"\n    },\n    {\n    \"dataElement\": \"AiPqHCbJQJ2\",\n    \"categoryOptionCombo\": \"tSwmrlTW11V\",\n    \"value\": \"Rendered v4\"\n    },\n    {\n    \"dataElement\": \"AiPqHCbJQJ2\",\n    \"categoryOptionCombo\": \"GYRYyntlK7n\",\n    \"value\": \"Rendered v5\"\n    }\n  ]\n}]")
               ...
               (map parse-string (rt/render-templates [template-map1 template-map2] extra-params "/" query-results))
               =>
               expected)))
